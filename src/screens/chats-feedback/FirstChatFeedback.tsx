      ...
      <Box margin="medium">
        ...
        <RadioButtonGroup
          ...
          value={(() => {
            ...
            return firstQuestionOptions[firstQuestionChoice];
          })()}
          onChange={event => {
            const { value } = event.target;

            const choiceIndex = firstQuestionOptions.indexOf(value);

            setQuestionChoice(0)(choiceIndex);
          }}
        />
      </Box>
      ...
      <Box margin="medium">
        ...
        <RadioButtonGroup
          ...
          value={(() => {
            ...
            return secondQuestionOptions[secondQuestionChoice];
          })()}
          onChange={event => {
            const { value } = event.target;

            const choiceIndex = secondQuestionOptions.indexOf(value);

            setQuestionChoice(1)(choiceIndex);
          }}
        />
      </Box>
